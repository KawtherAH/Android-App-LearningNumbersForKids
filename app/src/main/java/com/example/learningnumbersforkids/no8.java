...
public class no8 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no8, R.drawable.no8_1, R.drawable.no8_2, R.drawable.no8_3};
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.eight).start();
    }
}
