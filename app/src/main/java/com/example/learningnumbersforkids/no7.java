...
public class no7 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no7, R.drawable.no7_1, R.drawable.no7_2, R.drawable.no7_3};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_no7, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        TextView title = view.findViewById(R.id.HomeTitle);
        title.setText("Number Seven");
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.seven).start();
    }
}
