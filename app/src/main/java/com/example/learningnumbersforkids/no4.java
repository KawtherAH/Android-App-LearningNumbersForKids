...
public class no4 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no4, R.drawable.no4_1, R.drawable.no4_2, R.drawable.no4_3};
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.four).start();
    }
}
