...
public class no9 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no9, R.drawable.no9_1, R.drawable.no9_2, R.drawable.no9_3};
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.nine).start();
    }
}
