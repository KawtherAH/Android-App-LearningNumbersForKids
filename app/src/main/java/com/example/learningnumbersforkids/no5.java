...
public class no5 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no5, R.drawable.no5_1, R.drawable.no5_2, R.drawable.no5_3};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_no5, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        TextView title = view.findViewById(R.id.HomeTitle);
        title.setText("Number Five");
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.five).start();
    }
}
