...
public class no2 extends Fragment implements View.OnClickListener{
    ...
    Integer ListImg[] = {R.drawable.no2, R.drawable.no2_1, R.drawable.no2_2, R.drawable.no2_3};
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.two).start();
    }
}
