...
public class no6 extends Fragment implements View.OnClickListener{

    ImageSwitcher switcher;
    Integer ListImg[] = {R.drawable.no6, R.drawable.no6_1, R.drawable.no6_2, R.drawable.no6_3};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_no6, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        TextView title = view.findViewById(R.id.HomeTitle);
        title.setText("Number Six");
    ...
    public void Play() {
        MediaPlayer.create(getActivity(), R.raw.six).start();
    }
}
